...
<div class="row" style="width:1210px;margin:0 auto;">
    ...
    <div class="col-md-2">
        <a href="/historyRecord//getProductById?id=1">
            <img src="products/1/cs10001.jpg" width="170" height="170" style="display: inline-block;">
        </a>
        <p><a href="/historyRecord//getProductById?id=1" style='color:green'>衣服</a></p>
        <p><font color="#FF0000">商城价：&yen;299.00</font></p>
    </div>

    <div class="col-md-2">
        <a href="/historyRecord//getProductById?id=2">
            <img src="products/1/cs10002.jpg" width="170" height="170" style="display: inline-block;">
        </a>
        <p><a href="/historyRecord//getProductById?id=2" style='color:green'>眼镜</a></p>
        <p><font color="#FF0000">商城价：&yen;299.00</font></p>
    </div>

    <div class="col-md-2">
        <a href="/historyRecord//getProductById?id=3">
            <img src="products/1/cs10003.jpg" width="170" height="170" style="display: inline-block;">
        </a>
        <p><a href="/historyRecord//getProductById?id=3" style='color:green'>包</a></p>
        <p><font color="#FF0000">商城价：&yen;299.00</font></p>
    </div>

    <div class="col-md-2">
        <a href="/historyRecord//getProductById?id=4">
            <img src="products/1/cs10004.jpg" width="170" height="170" style="display: inline-block;">
        </a>
        <p><a href="/historyRecord//getProductById?id=4" style='color:green'>手机</a></p>
        <p><font color="#FF0000">商城价：&yen;299.00</font></p>
    </div>
    <div class="col-md-2">
...
<div style="width:1210px;margin:0 auto; padding: 0 9px;border: 1px solid #ddd;border-top: 2px solid #999;height: 246px;">
    ...
    <h4 style="width: 50%;float: left;font-size: 14px/30px ;font-family: 微软雅黑 " ;">浏览记录<a href="/historyRecord/clearHistory">clear</a></h4>
